...
Ce deck de cartes est un outil de génération d'idées et d'inspiration narrative, parfait pour les Maîtres de Jeu (MJ) ou pour jouer en solo/coopératif sans MJ.  
Chaque carte est conçue pour poser une question ou enrichir une scène, un lieu ou un personnage non-joueur (PNJ).
...
1. Posez une question nécessitant une réponse simple  
   (ex : « Le garde nous laisse-t-il passer ? »).
2. Tirez une carte.
